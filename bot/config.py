...
После подсчета КБЖУ и вывода отчета можно откорректировать вес или состав блюда, нажав кнопку <b>«Изменить» ✏️</b>.  Например, написать "Вместо масла творожный сыр". Бот пересчитает КБЖУ и выведет обновленный отчет.
