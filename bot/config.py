...
<b>Уже второй день вместе</b> 💚
Отправь завтрак или обед — я посчитаю КБЖУ.

Хочешь видеть полную картину дня?
Задай цель по калориям /set_goal — и я буду отслеживать недобор/перебор за тебя 👌🏻
"""

# День 3
TRIAL_NOTIFICATION_DAY_3 = """
<b>Сегодня — последний день пробного периода в Тарелке</b> 🥣
Я всё ещё считаю КБЖУ бесплатно — просто отправь фото, голосовое или текст.

⚠️ С завтрашнего дня бот станет недоступен без подписки.
Хочешь продолжить вместе? Оформи подписку и я буду рядом каждый приём пищи 💚
...
<b>Твой пробный период в Тарелке закончился</b> 😔
Я больше не могу считать калории и вести дневник...
Но всё легко вернуть — просто оформи подписку, и мы продолжим вместе 💚
...
<b>Хочешь вернуться к подсчётам? Я всё помню</b> 🥣
Твои отчёты ждут, и я снова готов помочь тебе с питанием.

💚 Вернуться и продолжить → /subscribe
"""